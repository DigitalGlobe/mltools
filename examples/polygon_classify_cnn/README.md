...
2. [**fit_xy**(X_train, Y_train, validation_split, save_model, nb_epoch)](#fit_xy): Train PoolNet on X and Y.  
3. [**fit_generator**(train_shapefile, batches, batches_per_epoch, min_chip_hw, max_chip_hw, validation_split, save_model, nb_epoch)](#fit_generator): For training PoolNet on more chips than will fit into memory.  
