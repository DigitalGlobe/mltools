...
class TomnodCommunicator():
    ...
    def _fetch(self, query):
        connection = self._get_connection(credentials)
    ...
    def get_high_confidence_features(self,
        ...
        '''Read high-confidence data from a Tomnod classification campaign for 
           given image and given class. Features are read in decreasing score 
           order. The purpose of this function is to create training/test 
           data for a machine.
           
           Args:
               schema (str): Campaign schema.
               image (str): Image catalog id.
    ...
    def get_low_confidence_features(self,
        ...
        '''Read low-confidence data from a Tomnod classification campaign for a 
           given image. Features are read from the DB in increasing score order, 
...
def write(self, data, schema, table, attribute_names, batch_size = 1000):
    '''Write data to the corresponding attributes in schema.table for all 


       Args:
           data: List of tuples.
           schema (str): Campaign schema.
           table (str): Table of schema.
...
def write_scores_and_priorities(input_file,
                                ...
                                batch_size = 1000, 
                                max_votes = 0):
    """Write contents of geojson to schema.feature
